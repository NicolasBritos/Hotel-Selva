...
<html>
	...
	<link rel="preconnect" href="https://fonts.googleapis.com">
     ...
     <nav>   
        ...
        <label>Dni</label>
      <input class="controls"  type="number" placeholder="Ingresa dni..." required name="dni" required value="<%=emp.getDni()%>"> 
      <br />
        <label>Apellido</label>
      <input class="controls" type="text" placeholder="Ingresa apellido..." required name="apellido" required value="<%=emp.getApellido()%>"> 
      <br />
        <label>Nombre</label>
      <input class="controls" type="text" placeholder="Ingresa nombre..." required name="nombre" required value="<%=emp.getNombre()%>"> 
      <br />
      ...
      <input class="controls" type="text" placeholder="Ingresa direccion..." required name="direccion"required value="<%=emp.getDireccion()%>"> 
         <br />
      <label> Cargo </label>
      ...
      <option >Administrador</option>
       ...
       <br />
      <label>Usuario</label>
      <input class="controls" type="text"placeholder="Ingresa usuario..." required name="usuario"required value="<%=emp.getUsuario().getUser()%>">
      <label>Contraseña</label>
      <input class="controls" type="text"placeholder="Ingresa contraseña..." required name="password"required value="<%=emp.getUsuario().getPassword() %>">
                    </div>
