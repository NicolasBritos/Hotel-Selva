	...
	<link rel="preconnect" href="https://fonts.googleapis.com">
     ...
     <nav>   
        <ul>
          ...
          <div class="div-main">
         <form action="SvBuscarReservaPorHuespRango" method="GET">
              <div class="div-find-emp">
                          <h3 class="title-form" >Buscar reserva por Huesped y Rango</h3>
                          <label>Dni Huesped</label>
      <input class="controls"  type="number" placeholder="" required name="dni" required > 
      <br />
        <label>Fecha 1</label>
      <input class="controls"  type="date" placeholder="" required name="fecha1" required > 
      <br />
        <label>Fecha 2</label>
      <input class="controls"  type="date" placeholder="" required name="fecha2" required > 
      <br />
                           </div>
