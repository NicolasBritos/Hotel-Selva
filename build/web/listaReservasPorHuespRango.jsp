...
<html id="listaEmpleados">
  ...
  <div class="container">
	<table>
            <caption class="title-form">Reservas del Huesped en el rango buscado</caption>
		<thead>
			<tr>
		...
		<tbody>
				...
				<td><%=apellido%></td>
                                ...
                                <td>                
                                    <form name="editar" action="SvEditarReserva" method="POST" style="display:inline" >  
                                        <input type="hidden" name ="habitacion" value="<%=nroHabitacion%>">
