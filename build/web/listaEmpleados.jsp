...
<html id="listaEmpleados">
  ...
  <div class="container">
	<table>
            <caption class="title-form">Empleados</caption>
		<thead>
			<tr>
				<th class='nom-column'>Dni</th>
				<th class='nom-column'>Nombre</th>
				<th class='nom-column'>Usuario</th>
                                                                                 <th class='nom-column'>Cargo</th>
		...
		<tbody>
                    ...
                    for (Empleado emp : listaEmpleados){
                        %>
                    			<tr>
                                                             <% String nombreComp = emp.getApellido() + " " + emp.getNombre();
                                                                     int dni = emp.getDni();
                                                                     int idUsuario = emp.getUsuario().getIdUsuario();
                                                                    String cargo = emp.getCargo();
                                                                     String dniEmp = String.valueOf(emp.getDni());
                                                                     String user = emp.getUsuario().getUser();  %>
				<td><%=dniEmp%></td>
				<td><%=nombreComp%> </td>
				<td><%=user%></td>
                                                                                 <td><%=cargo%></td>
